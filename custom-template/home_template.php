                                    ...
                                    <div class="promotions-popup-header">
                                        <div class="popup-header-left">
                                            <div class="promotion expanded">
                                                <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/logo.png" alt="Comfy Heating &amp; Air Conditioning Inc. Coupon" class="promotion-logo" />
                                ...
                                <div class="popup-inner">
                                    <div class="promotions-popup-header">
                                        <div class="popup-header-left">
                                            <div class="promotion expanded">
                                                <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/logo.png" alt="Comfy Heating &amp; Air Conditioning Inc. Coupon" class="promotion-logo" />
                                                <h2><a href="/promotions/39/receive-up-to-6500">Receive Up To $6500</a></h2>
                                ...
                                <fieldset>
                                    <ul>
                                        ...
                                        <li id="item-li-6" class="checkbox required">
                                            <p class="label-heading"></p><span class="wrapper"><label for="dataformresponse106_169bffd24da6f1"><input type="checkbox" name="data[FormResponse-10][6][]" id="dataformresponse106_169bffd24da6f1" value="1"> <span>Yes! Sign me up for the Comfy Heating &amp; Air Conditioning Inc. email list</span></label></span>
                                        </li>
                                    </ul>
                                </fieldset>
                                <fieldset>
